...
<table id="blueone" class="table">
	...
	<tr>
		<td> PASSWORD:</td>
		<td colspan=2><input type ="password" id ="pw1" name="pwd"> * (영문,특수기호포함)</td>
	</tr>
	<tr>
		<td> 암호확인:</td>
	...
	<tr>
		<td> 등급:</td>
		<td colspan=2><input type ="radio" value =1  name ="admin">일반회원<input type ="radio" value =2  name ="admin">관리자</td>
	</tr>
	<tr>
		<td></td>
		<td colspan=2><input type ="button" id ="btnIn" value ="확인"><input type ="button" value ="취소"></td>
	</tr>
</table>
</form>
</body>
